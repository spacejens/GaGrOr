...
public class Wh40kSkirmishGroupServiceUnitTest {

	private static final Long GROUP_ID = 1L;
	private static final String GROUP_NAME = "Group";
	private static final MemberType MEMBER_TYPE = MemberType.MEMBER;

	Wh40kSkirmishGroupService instance;
	...
	public void viewGroup_member_ok() {
		final Wh40kSkirmishGroupOutput result = instance.viewGroup(GROUP_ID);
	...
	public void setupInstance() {
		instance = new Wh40kSkirmishGroupService();
