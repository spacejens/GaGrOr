...
public class UserTest extends EntityTestSupport {
	...
	@Test
	public void testOK() {
		for (int uLength = SecurityConstants.USERNAME_MIN_LENGTH; uLength <= SecurityConstants.USERNAME_MAX_LENGTH; uLength++) {
			for (int pLength = SecurityConstants.PASSWORD_ENCRYPTED_MIN_LENGTH; pLength <= SecurityConstants.PASSWORD_ENCRYPTED_MAX_LENGTH; pLength++) {
