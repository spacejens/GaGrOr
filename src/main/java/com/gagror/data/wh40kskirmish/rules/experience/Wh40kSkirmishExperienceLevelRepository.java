...
public interface Wh40kSkirmishExperienceLevelRepository extends Repository<Wh40kSkirmishExperienceLevelEntity, Long> {
	...
	Wh40kSkirmishExperienceLevelEntity save(final Wh40kSkirmishExperienceLevelEntity experienceLevel);

	void delete(final Wh40kSkirmishExperienceLevelEntity experienceLevel);
}
